...
import 'package:getlearn_app/presentation/screens/sliver_home_screen.dart';
import 'package:getlearn_app/presentation/utility/app_colors.dart';
import 'package:getlearn_app/presentation/utility/asset_path.dart';
import 'package:getlearn_app/presentation/widgets/circle_button.dart';
import 'package:getlearn_app/presentation/widgets/point_text.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Positioned(top: 0, left: 0, right: 0, height: mq.height * 0.15, child: appBarSection()),
          Positioned(
            top: mq.height * 0.12,
            left: 0,
            right: 0,
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                            width: mq.width,
                            child: OutlinedButton(onPressed: () {}, child: const Text("16 more section"))),
                        const SizedBox(height: 20),
